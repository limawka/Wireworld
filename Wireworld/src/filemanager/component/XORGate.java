...
public class XORGate implements Component{
    ...
    public static final Cell[][] componentBasicArray = {
            {EMPTY, CONDUCTOR, EMPTY, EMPTY, EMPTY, CONDUCTOR, EMPTY},
            {CONDUCTOR, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, CONDUCTOR},
            {CONDUCTOR, EMPTY, CONDUCTOR, CONDUCTOR, CONDUCTOR, EMPTY, CONDUCTOR},
            {EMPTY, CONDUCTOR, CONDUCTOR, EMPTY, CONDUCTOR, CONDUCTOR, EMPTY},
            {EMPTY, EMPTY, CONDUCTOR, CONDUCTOR, CONDUCTOR, EMPTY, EMPTY},
            {EMPTY, EMPTY, CONDUCTOR, CONDUCTOR, CONDUCTOR, EMPTY, EMPTY},
            {EMPTY, EMPTY, EMPTY, CONDUCTOR, EMPTY, EMPTY, EMPTY}
    };
